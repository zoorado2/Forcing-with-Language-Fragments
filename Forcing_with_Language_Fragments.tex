...
\begin{enumerate}[label=Case \arabic*:, leftmargin=50pt]
    ...
    \begin{itemize}
        ...
        \item we may safely assume $\phi^{\dagger}$ to be $\mathcal{L}^{*}_{\mathfrak{A}}$-$\Sigma_1$, and

...
We are now fully equipped to tackle \ref{qn0}. In the presence of Proposition \ref{certgood}, the next lemma immediately implies an affirmative answer to \ref{qn0}.
...
\end{itemize}
Trivially, \ref{3397} and \ref{3398} are done, and $\phi$ is a $\mathcal{L}^{*}_{\mathfrak{A}'}$-$\Sigma_2$ sentence.

Choose any $p \in P'$. It is not hard to see that there exists 
\begin{equation*}

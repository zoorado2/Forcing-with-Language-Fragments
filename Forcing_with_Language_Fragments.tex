...
\begin{rem}
It is actually useful to note that Case 3 of the inductive step in the inductive proof of Lemma \ref{uni} is, for lack of a better term, superfluous. Indeed, this means substituting ``$\mathcal{L}^{*}_{\mathfrak{A}}$-$\Sigma_1$'' for ``$\mathcal{L}^{*}_{\mathfrak{A}}$-$\Pi_2$'' in any of
\begin{itemize}
    \item Lemma \ref{uni},
...
One may argue that the remark below has been a long time coming, ever since the proof of Lemma \ref{lem339} was laid out.

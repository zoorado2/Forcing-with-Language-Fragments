...
In the spirit of Jensen's results on the extended Namba problem, we are interested in whether the forcing notion $\mathbb{P}_{\lambda_f}$ constructed in the proof of Theorem \ref{notion1} adds reals under the right assumptions. More generally, we can ask the same about the parametrised versions of said forcing notion. 

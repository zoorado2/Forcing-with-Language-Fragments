...
Let $\mathfrak{A} = (H(\omega); \in, \mathbb{P}(\mathfrak{T})^{\top})$, so that 
\begin{itemize}
...
\end{itemize}
whence $\mathfrak{A}$ is $\mathcal{L}_{\mathfrak{T}}$-suitable. We argue as in the proof of Lemma \ref{ctblegeneric} to conclude the following:
\begin{enumerate}[label=(\arabic*)]
    \item\label{5571} $\Gamma_{\mathfrak{T}}$ is a set of $(\mathcal{L}_{\mathfrak{T}})^*_{\mathfrak{A}}$-$\Pi_2$ sentences, and
    \item\label{5572} Lemma \ref{main2} can be applied to arrive at (\ref{marker0}).
\end{enumerate}
Noting that
\begin{itemize}
...
Passing \ref{5571} to \ref{5573} through $f$ the way (\ref{marker}) was passed through $f$ in the proof of Lemma \ref{ctblegeneric}, for some oracle machine $\bar{\Phi}$ we have

...
\end{lem}
\begin{proof}
Since $\mathrm{NS}_{\omega_1}$ being saturated implies $\mathrm{NS}_{\omega_1}$ is precipitous, the lemma immediately follows from applications of Lemmas \ref{itercopy} and~\ref{iterlength} in $W$, with $$(V; \in, \mathrm{NS}_{\omega_1}^V)$$ in place of $\bar{M}$, while noting Fact~\ref{satipre}.
\end{proof}
